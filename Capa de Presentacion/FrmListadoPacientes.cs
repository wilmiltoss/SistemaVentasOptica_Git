...
{
    public partial class FrmListadoPacientes : DevComponents.DotNetBar.Metro.MetroForm
    {
        ...
        private void btnNuevo_Click(object sender, EventArgs e)
        {
            ...
            //else
            //{
                FrmRegistroPacientes C = new FrmRegistroPacientes(); 
                if (dataGridView1.SelectedRows.Count > 0)
                    Program.Evento = 1;
                else
                    Program.Evento = 0;
        ...
        private void btnActualizar_Click(object sender, EventArgs e)
        {
            if (dataGridView1.SelectedRows.Count > 0)
            {
                FrmRegistroPacientes FrmC = new FrmRegistroPacientes();
                FrmC.txtCi.Text = dataGridView1.CurrentRow.Cells[1].Value.ToString();
                ...
                FrmC.txtEmail.Text = dataGridView1.CurrentRow.Cells[6].Value.ToString();
                FrmC.txtCi.Focus();
                FrmC.Show();
                if (dataGridView1.SelectedRows.Count > 0)
                    Program.Evento = 1;
